...
export default function CaldimCalculates() {
  ...
  return (
    <div style={{ background: T.win, padding: 4, borderRadius: 8, fontFamily: "Segoe UI, sans-serif", userSelect: "none", position: "relative" }}>
      {/* Title Bar */}
      <div style={{
        ...
        <div style={{ display: "flex", gap: 4 }}>
          <button style={{ ...BS(), fontSize: 10, padding: "1px 6px" }}>_</button>
          <button style={{ ...BS(), fontSize: 10, padding: "1px 6px" }}>□</button>
          <button style={{ ...BS(T.clear), fontSize: 10, padding: "1px 6px" }}>✕</button>
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: 3 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{
            ...
            <button style={BS(T.special)}>ASIN</button>
            <button style={BS()}>OFF</button>
            ...
            <button style={BS(T.special)}>ACOS</button>
            ...
            <button style={BS(T.special)}>ATAN</button>
            ...
            <button style={BS(T.special)}>👁</button>
