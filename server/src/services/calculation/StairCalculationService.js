      ...
      rails: await Promise.all((takeoff.rails || []).map(async rail => {
        ...
        return {
          ...
          systemCalc: {
            ...
            steelWithScrap: this.roundExcel(finalWeight / (lengthFt || 1), 3),
            totalSteel: this.roundExcel(finalWeight, 3),
      ...
      platforms: await Promise.all((takeoff.platforms || []).map(async p => {
        ...
        return {
          ...
          systemCalc: {
            ...
            steelWithScrap: this.roundExcel(finalWeight / (area || 1), 3),
            totalSteel: this.roundExcel(finalWeight, 3),
            baseSteelLbs: this.roundExcel(baseWeight, 3),
      ...
      stairs: await Promise.all((takeoff.stairs || []).map(async s => {
        ...
        return {
          ...
          systemCalc: {
            ...
            steelWithScrap: this.roundExcel((stringerBaseWeight * 1.10) / (risers || 1), 3),
            totalSteel: this.roundExcel(totalUnitWeight, 3),
