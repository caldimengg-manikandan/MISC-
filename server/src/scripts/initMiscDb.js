    ...
    try {
        ...
        await pool.request().query(`
            CREATE TABLE [projects] (
                ...
                [estimationResult] NVARCHAR(MAX),
                [totalWeight] DECIMAL(15,6) DEFAULT 0,
                ...
                [engineerId] BIGINT,
                [assignedEngineer] NVARCHAR(255),
                [reviewer_id] BIGINT,
                [reviewer_email] NVARCHAR(255),
                [review_count] INT DEFAULT 0,
                [push_back_reason] NVARCHAR(MAX),
                [sent_to_email] NVARCHAR(500),
                [sent_to_cc] NVARCHAR(500),
                [sent_at] DATETIME,
                [sent_by] BIGINT,
