...
class PanPlateWeightCalculationService {
  ...
  calculatePanPlateWeight(
    ...
    try {
      ...
      // STEP 3: Convert stair width to inches
      const L = stairWidthFeet * 12;
      
      // STEP 4: Calculate raw weight using engineering formula
      const rawWeight = T * W * L * PanPlateWeightCalculationService.DENSITY;
      ...
      return {
        ...
        calculation: {
          ...
          costPerLb: costPerLb,
          formula: `${T} × ${W} × ${L} × ${PanPlateWeightCalculationService.DENSITY}`,
          result: rawWeight
        },
