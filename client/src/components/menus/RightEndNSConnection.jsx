...
const RightEndNSConnection = ({ formData, handleChange }) => {
  return (
    <div className="space-y-4">
      <h4 className="font-semibold text-gray-800">Right End NS Connection</h4>
      
      <ConnectionSubMenu title="Connection Type" defaultOpen={true}>
        <div className="space-y-4">
          <select
            name="rightNSConnectionType"
            value={formData.rightNSConnectionType || ''}
      ...
      <ConnectionSubMenu title="Connection Specification">
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <input
              type="text"
              name="rightNSBoltSize"
              value={formData.rightNSBoltSize || ''}
              onChange={handleChange}
          ...
          <div>
            ...
            <input
              type="text"
              name="rightNSBoltGrade"
              value={formData.rightNSBoltGrade || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div>
            ...
            <input
              type="text"
              name="rightNSWeldSize"
              value={formData.rightNSWeldSize || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder="e.g., 1/4&quot;"
            />
      ...
      <ConnectionSubMenu title="Material Settings">
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <select
              name="rightNSConnectionMaterial"
              value={formData.rightNSConnectionMaterial || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
          ...
          <div>
            ...
            <select
              name="rightNSConnectionFinish"
              value={formData.rightNSConnectionFinish || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
      ...
      <ConnectionSubMenu title="Connection to Support (1)">
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <select
              name="rightNSSupport1Type"
              value={formData.rightNSSupport1Type || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
          ...
          <div>
            ...
            <input
              type="text"
              name="rightNSSupport1Anchor"
              value={formData.rightNSSupport1Anchor || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      ...
      <ConnectionSubMenu title="Connection to Support (2)">
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <select
              name="rightNSSupport2Type"
              value={formData.rightNSSupport2Type || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
              <option value="">Select Support Type</option>
          ...
          <div>
            ...
            <input
              type="text"
              name="rightNSSupport2Anchor"
              value={formData.rightNSSupport2Anchor || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder="e.g., Wedge Anchor"
            />
...
export default RightEndNSConnection;