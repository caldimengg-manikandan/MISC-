...
const RightEndFSConnection = ({ formData, handleChange }) => {
  return (
    <div className="space-y-4">
      <h4 className="font-semibold text-gray-800">Right End FS Connection</h4>
      
      <ConnectionSubMenu title="Connection Type" defaultOpen={true}>
        <div className="space-y-4">
          <select
            name="rightFSConnectionType"
            value={formData.rightFSConnectionType || ''}
      ...
      <ConnectionSubMenu title="Connection Specification">
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <input
              type="text"
              name="rightFSBoltSize"
              value={formData.rightFSBoltSize || ''}
              onChange={handleChange}
          ...
          <div>
            ...
            <input
              type="text"
              name="rightFSBoltGrade"
              value={formData.rightFSBoltGrade || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      ...
      <ConnectionSubMenu title="Material Settings">
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <select
              name="rightFSConnectionMaterial"
              value={formData.rightFSConnectionMaterial || ''}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
...
export default RightEndFSConnection;